...
func init() {
	...
	createCmd.Flags().StringVarP(&createRecipe, "recipe", "R", "", "Create from a Recipe YAML file")
	createCmd.Flags().BoolVarP(&createOven, "oven", "O", false, "Claim a prepared local Oven slot, with cold fallback")
